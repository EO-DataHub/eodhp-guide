---
title: Contributing — Processes
doc_status: unreviewed
---

# Processes

Scrum and engineering process documentation that supports the programme (not EO Data Hub platform operations).

Migrate from:

| Source |
|--------|
| `docs/documentation-repo/ProcessesAndScrum/Sprint Turnover.md` |
| `docs/documentation-repo/ProcessesAndScrum/Repositories and Branching.md` |
