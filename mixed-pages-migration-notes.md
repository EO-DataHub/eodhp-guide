...
| `docs/operations/titiler/stac-collection-wmts.md` | Inline **Key parameters** resembles reference inside a deploy/test procedure. | Single how-to under [Data and catalogues](../how-to/data-and-catalogues/titiler-stac-collection-wmts.md); split parameter tables to Reference only if repeated across many collections. |
